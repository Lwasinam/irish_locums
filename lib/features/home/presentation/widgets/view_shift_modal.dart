...
class _ViewShiftModalState extends State<ViewShiftModal> {
  ...
  getPermissions() async {
    ...
    setState(() {
      ...
      userId = _prefHelper.getValue('userId');
    });
  }
  ...
  applyForJob() async {
    ...
    Map response =
        await Provider.of<ApplicationsRepository>(context, listen: false)
            .applyForJob(widget.job.id!, userId!, 'userNote');
